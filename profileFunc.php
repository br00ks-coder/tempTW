<?php   
session_start();
$dbconn = pg_connect("host=localhost dbname=webgardening user=postgres password=paroladb");
if (!$dbconn) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: registerResponse.php?message=" . urlencode($successMessage));
    ...
    header("Location: registerResponse.php?message=" . urlencode($errorMessage));
    exit; // Make sure to exit after the redirection
    }
}
